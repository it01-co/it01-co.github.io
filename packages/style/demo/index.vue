<template>
  <demo-section>
    <demo-block :title="$t('ellipsis')">
      <div class="h-ellipsis">{{ $t('text') }}</div>
    </demo-block>

    <demo-block :title="$t('hairline')">
      <div class="h-hairline--top" />
    </demo-block>
    ...
    <demo-block :title="$t('animation')">
      <h-cell
        is-link
        title="Fade"
        @click="animate('h-fade')"
      />
      <h-cell
        is-link
        title="Slide Up"
        @click="animate('h-slide-up')"
      />
      <h-cell
        is-link
        title="Slide Down"
        @click="animate('h-slide-down')"
      />
      <h-cell
        is-link
        title="Slide Left"
        @click="animate('h-slide-left')"
      />
      <h-cell
        is-link
        title="Slide Right"
        @click="animate('h-slide-right')"
      />
    </demo-block>
